...
#ifndef _STK_PATTERNFEATURE_ENTITY_H_
#define _STK_PATTERNFEATURE_ENTITY_H_
 ...
 ****************************************************************************/
class DATAMANAGER_API Stk_PatternFeature :
...
public:
	 ...
	 *	@attention	无
	 ****************************************************************************/
	Stk_PatternFeature(Stk_DocumentManager* i_stkDocManagerP, Stk_ProtoType* i_stkProtoP);
