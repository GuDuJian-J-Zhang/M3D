...
#ifndef _STK_DEFINE_H_
#define _STK_DEFINE_H_
...
typedef struct { STK_FLOAT32 PlcMatrix[4][4];} STK_MTX32;
typedef struct { STK_FLOAT32 BoundBox[2][3];} STK_BOX32;
typedef struct { STK_FLOAT32 Red;STK_FLOAT32 Green; STK_FLOAT32 Blue; STK_FLOAT32 Alpha;} STK_RGBA32;
typedef struct { STK_FLOAT32 Ambient;STK_FLOAT32 Diffuse; STK_FLOAT32 Specular;} STK_MAT32;
typedef struct { STK_FLOAT32 X;STK_FLOAT32 Y; STK_FLOAT32 Z;} STK_PNT32;
typedef	struct { STK_FLOAT32 X;STK_FLOAT32 Y;STK_FLOAT32 Z;} STK_DIR32;
...
/**********************************************************
*		Created on 2013/07/14 By Gaoqq
*	All Rights Reserved. Copyright(C) 2012 HOTEAMSOFT
*
*	Function:
*		SVL 物理文件相关定义
