...
#ifndef _SVLLIB_FEAT_HOLE_ENTITY_H_
#define _SVLLIB_FEAT_HOLE_ENTITY_H_
...
namespace HoteamSoft {
	namespace SVLLib {
		...
		class STK_TOOLKIT_EXPORT Stk_Feat_Axis
		{
		private:
		...
		/****************************************************************************
			 ...
			 *
		 ****************************************************************************/
		class STK_TOOLKIT_EXPORT Stk_FeatLimit
		{
		private:
			StkLimitTypeEnum		m_eLimitType;				//!< Limit类型
			STK_DOUBLE64			m_dValue;					//!< Limit长度
			Stk_ConnectorPtr		m_stkNodeConnectorP;		//!< 关联要素
		public:
			/****************************************************************************
			 *	@brief		构造函数
			 *	@param[in]	无
		...
		public:
			 ...
			 *	@attention	无
			 ****************************************************************************/
			STK_STATUS				SetReferenceObject(Stk_ConnectorPtr i_NodeConnectorP);
			 ...
			 *	@attention	无
			 ****************************************************************************/
			Stk_ConnectorPtr		GetReferenceObject();
		};
		...
		class STK_TOOLKIT_EXPORT Stk_FeatInnerThread
		{
		private:
			...
			Stk_ConnectorPtr		m_NodeConnectorP;			//!< 只有当m_eThreadLimitType类型为TYPE_THREAD_UP_TO_PLANE时，才会有该属性
		public:
			/****************************************************************************
			 *	@brief		构造函数
			 *	@param[in]	无
		...
		public:
			...
			/****************************************************************************
			*	@brief		设置螺纹直径公差
			*	@param[in]	i_dDepthTol		直径公差
			*	@param[out]	无
			*	@retval		STK_SUCCESS		设置成功
			*	@note		无
			*	@attention	无
			****************************************************************************/
			STK_STATUS				SetDiameterTol(STK_DOUBLE64 i_dDiameterTol);
			...
			****************************************************************************/
			 ...
			 *	@attention	无
			 ****************************************************************************/
			STK_STATUS				SetThreadLimitReference(Stk_ConnectorPtr i_NodeConnectorP);
			 ...
			 *	@attention	无
			 ****************************************************************************/
			Stk_ConnectorPtr		GetThreadLimitReference();
		...
		class STK_TOOLKIT_EXPORT Stk_Feat_Hole
			: public Stk_Object
		{
			STK_DECLARE_CLASS(Stk_Feat_Hole)
		protected:
			enum { _typeID = _SVLLIB_TYPE_FEAT_HOLE };	//!< 类别
		private:
