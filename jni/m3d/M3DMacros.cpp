...
const string SCREENUILAYER_GROUPNODE = "M3D|MAIN|SCREEN_UI_LAYER_GROUP";

const string SECTION_GROUP_PATH = "M3D|MAIN|SECTIONGROUPNODE";
const string NOTE_GROUP_PATH = "M3D|MAIN|NOTEGROUPNODE";
const string ANNOTATION_GROUP_PATH = "M3D|MAIN|ANNOTATIONGROUPNODE";
const string MEASURE_GROUP_PATH = "M3D|MAIN|MEASUREGROUPNODE";
const string LIGHT_GROUP_PATH = "M3D|MAIN|LIGHTGROUPNODE";
const string CAMERA_GROUP_PATH = "M3D|MAIN|CAMERAGOUPNODE";
...
const int LIGHT_GROUP_NODE = 80;
const int CAMERA_GROUP_NODE = 81;
const int SCREENLAYER_GROUP_NODE = 82;
...
const string M3D_DEFAULT_MATERIAL = "m3d_default_material";
