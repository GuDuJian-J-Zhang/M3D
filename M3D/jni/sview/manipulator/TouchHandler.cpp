...
{
	LOGI(" TouchHandler::SetUpDirection");
	...
	Quaternion modelRotation(Vector3::UP, m_upDirection);
...
void TouchHandler::SetBirdEyeParameter(int pointId, float speed)
{
	...
	Shape* firstShape = this->m_SceneManager->GetShape(pointId);
