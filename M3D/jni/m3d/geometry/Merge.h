...
namespace M3D {
	...
	public:
		...
		static bool MergeModelFaces(Model* model, int MergeFlg, int iEliminateFlg, bool NeedSetMatrix = false);
		...
		static string CalculateParentPlcPath(string strPlcPath1, string strPlcPath2);
		...
		static bool HaveInteraction(vector<Body*>* bodys, Body* targetBody);
	private:
