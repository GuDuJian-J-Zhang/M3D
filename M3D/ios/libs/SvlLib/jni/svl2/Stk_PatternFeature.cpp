 ...
 *	@attention	无
 ****************************************************************************/
Stk_PatternFeature::Stk_PatternFeature(Stk_DocumentManager* i_stkDocManagerP, Stk_ProtoType* i_stkProtoP)
 ...
 *	@attention	无
 ****************************************************************************/
Stk_PatternFeature::~Stk_PatternFeature()
{
 ...
 *	@attention	无
 ****************************************************************************/
//STK_STATUS Stk_PatternFeature::SetPlcID(STK_ID i_idPlacement)
//{
 ...
 *	@attention	无
 ****************************************************************************/
//STK_ID Stk_PatternFeature::GetPlcID()
//{
 ...
 *	@attention	无
 ****************************************************************************/
STK_STATUS Stk_PatternFeature::AddChildInsPlcID(STK_ID i_idPlacement)
{
 ...
 *	@attention	无
 ****************************************************************************/
STK_UINT32 Stk_PatternFeature::GetChildInsNum()
{
 ...
 *	@attention	无
 ****************************************************************************/
STK_ID Stk_PatternFeature::GetChildInsPlcIDByIndex(STK_UINT32 i_nuIndex)
{
 ...
 *	@attention	无
 ****************************************************************************/
STK_STATUS Stk_PatternFeature::WriteFile(Stk_File *i_stkFileP)
{
	...
	ComponentFeatHead.kind = SEG_TYPE_COMP_PATTERN;
 ...
 *	@attention	内部接口
 ****************************************************************************/
STK_STATUS Stk_PatternFeature::ReadFile(Stk_File *i_stkFileP, StkSegmentHead *i_FeatHeadP)
{
	STK_STATUS				eState = STK_SUCCESS;
