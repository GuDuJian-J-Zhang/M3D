...
/* MD5 initialization. Begins an MD5 operation, writing a new context. */
  void stk::MD5::MD5_init(MD5_CTX * context)
{
...
void stk::MD5::MD5_update(MD5_CTX * context, const unsigned char *input, unsigned int inputLen)
{
...
void stk::MD5::MD5_finish(unsigned char digest[16], MD5_CTX * context)
{
...
char* stk::MD5::MD5_sign (const unsigned char *str, unsigned int len)
{
    int i;
    MD5_CTX     md5;
